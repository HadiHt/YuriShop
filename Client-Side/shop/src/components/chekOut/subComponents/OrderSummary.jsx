  ...
  return (
    <div className="ToTalSum">
      ...
      <div className="itemRow">
        ...
        <h4 className="item">Price in L.L</h4>
      </div>
      <hr />
      {items}
      <hr />
      ...
      <p className="AgreeConditionText">
        By pressing confirm you agree the Yuri Shop Conditions of Use, Sale And
        sharing your financial informations
      </p>
      <div className="itemrow">
        <button onClick={confirmPurchase} className="Buttonn item">
          Confirm
        </button>
      </div>
      {errorMessage && (
        <p className="error_message">
          {" "}
          please Add a payment method before proceeding with the order
        </p>
      )}
    </div>
  );
